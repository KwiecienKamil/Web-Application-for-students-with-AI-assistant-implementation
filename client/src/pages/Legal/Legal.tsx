		...
		<UserAuthWrapper>
			<div className="legal-page">
				<Link to="/" className="legal-logo-link">
					<img src={logo} alt="Ogarnij.to logo" />
				</Link>
				...
				<div className="legal-card">
					...
					<div className="legal-content">
						...
						<section>
							<h3>9. Pliki cookies i technologie podobne</h3>
							<p>
						...
						<section>
							<h3>10. Zmiany w regulaminie i polityce prywatności</h3>
							<p>
						...
						<section>
							...
							<p>
								...
								<a href="mailto:info@kamilkwiecien.tech">
									info@kamilkwiecien.tech
								</a>
								.
							</p>
